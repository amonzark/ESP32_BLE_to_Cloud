...
const int mqttPort = 17767; 
const char* mqttUser = "iimjdwxk"; 
const char* mqttPassword = "u1RWf81eDcvW"; 
...
if ( client.connect("ESPMQTT", mqttUser, mqttPassword) ) {
Serial.println( "[DONE]" ); 
} else { 
Serial.print( "[FAILED]" ); 
...
char attribut[100]; 
pData.toCharArray(attribut, 100); 
client.publish( "esp/test", attribut ); 
delay(2000); 
client.loop(); 
}
